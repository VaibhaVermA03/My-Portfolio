...
const About = () => {
  ...
  return (
    <section id="about" className="relative w-full px-8 md:px-20 pt-32 pb-0 flex flex-col md:flex-row gap-20 items-start z-10 overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full md:w-1/3 relative mt-10 md:mt-4 flex flex-col items-center order-2 md:order-1"
      >
        ...
        <div className="relative w-full mt-6 flex justify-center">
            <svg width="300" height="120" viewBox="0 0 300 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white overflow-visible">
      ...
      {/* Right Wrapper: Text Content 
         MOBILE: order-1 (Upar)
         DESKTOP: md:order-2 (Right side)
      */}
      <motion.div 
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        {/* Updated Heading: Single Line on Mobile */}
        {/* text-4xl mobile ke liye kiya hai taaki overflow na ho */}
        ...
        <p className="font-hand text-2xl md:text-3xl text-gray-400 mb-12">
          Vaibhav Verma
        </p>

        <p className="font-body uppercase text-justify text-xl md:text-2xl leading-relaxed tracking-wide text-gray-300 border-l-2 border-white/20 pl-8">
